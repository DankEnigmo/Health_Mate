...
class FallDetectorMulti:
    ...
    def load_model(self, path):
        ...
        # OPTIMIZATION: Set model to inference mode for better performance
    ...
    def get_pose(self, image):
        # OPTIMIZED: Reduced image size from 960 to 640 for faster processing
        # This significantly reduces latency with minimal accuracy loss
